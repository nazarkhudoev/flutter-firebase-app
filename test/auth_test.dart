...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    const user = AuthUser(id:'hgkhkhkhk', isEmailVerified: false, email: 'foo@bar.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(id: 'jhgjhg', isEmailVerified: true, email: 'foo@bar.com');
    _user = newUser;
  }
}
