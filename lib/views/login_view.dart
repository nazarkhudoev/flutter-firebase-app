...
import 'package:flutter_application_1/utilities/dialogs/loding_dialog.dart';
      ...
      listener: (context, state) async {
        if (state is AuthStateLoggedOut) {
          ...
          if (!state.isLoading && closeDialog != null) {
            ...
            _closeDialogHandle = showLodingDialog(
              context: context,
              text: 'Loading...',
            );
          }
          ...
          if (state.exception is UserNotFoundAuthException) {
            ...
            await showErrorDialog(context, 'Authentication arror');
          }
        }
      },
      child: Scaffold(
